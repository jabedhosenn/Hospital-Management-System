...
<div class="d-flex justify-content-center align-items-center"
    ...
    <div class="p-5 shadow-lg"
        ...
        <form action="{{ route('post_doctors') }}" method="POST" enctype="multipart/form-data">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" name="doctors_name" id="doctors_name"
                       class="form-control rounded-pill px-3" placeholder="Enter doctor's name" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="doctors_phone" id="doctors_phone"
                       class="form-control rounded-pill px-3" placeholder="Enter doctor's phone" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="speciality" id="speciality"
                       class="form-control rounded-pill px-3" placeholder="Enter speciality" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="department" id="department"
                       class="form-control rounded-pill px-3" placeholder="Enter department" required>
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="text" name="room_number" id="room_number"
                       class="form-control rounded-pill px-3" placeholder="Enter room number" required>
            </div>

            <!-- Doctor's Image -->
            <div class="mb-4">
                <label for="doctors_image" class="form-label text-white">Doctor's Image</label>
                <input type="file" name="doctors_image" id="doctors_image"
                       class="form-control rounded-pill px-3" accept="image/*" required>
            </div>
